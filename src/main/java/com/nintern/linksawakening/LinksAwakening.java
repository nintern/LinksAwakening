...
import com.nintern.linksawakening.init.ModBlocks;
...
public class LinksAwakening
{
	...
	public void preInit(FMLPreInitializationEvent event)
	{
		...
		LogHelper.info("Initializing custom configurations");
		ConfigurationHandler.init(event.getSuggestedConfigurationFile());
		FMLCommonHandler.instance().bus().register(new ConfigurationHandler());
		
		LogHelper.info("Initializing custom items");
		ModItems.init();
		
		LogHelper.info("Initializing custom blocks");
		ModBlocks.init();
